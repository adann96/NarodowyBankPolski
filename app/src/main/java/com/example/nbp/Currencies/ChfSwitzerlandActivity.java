...
public class ChfSwitzerlandActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chf_switzerland);
        mTextViewResult = findViewById(R.id.chfSwitzerlandRate);
    ...
    private void barChartCurrRates() {
        String url = "https://api.nbp.pl/api/exchangerates/rates/A/CHF/last/5/?format=json";
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                BarChart barChart = findViewById(R.id.chfBarChart);
