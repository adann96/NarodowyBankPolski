...
public class NokNorwayActivity extends AppCompatActivity {
    ...
    public void jsonParsing(final String param) {
        ...
        String url = "https://api.nbp.pl/api/exchangerates/rates/A/NOK/?format=json";
    ...
    private void barChartCurrRates() {
        String url = "https://api.nbp.pl/api/exchangerates/rates/A/NOK/last/5/?format=json";
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                BarChart barChart = findViewById(R.id.nokBarChart);
