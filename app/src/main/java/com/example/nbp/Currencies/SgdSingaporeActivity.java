...
public class SgdSingaporeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sgd_singapore);
        mTextViewResult = findViewById(R.id.sgdSingaporeRate);

        requestQueue = Volley.newRequestQueue(this);
        JsonParseSingleCurrency.jsonParsing("https://api.nbp.pl/api/exchangerates/rates/A/SGD/?format=json","mid",this,requestQueue,mTextViewResult);
    ...
    private void barChartCurrRates() {
        String url = "https://api.nbp.pl/api/exchangerates/rates/A/SGD/last/5/?format=json";
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                BarChart barChart = findViewById(R.id.sgdBarChart);
