...
public class GbpGreatBritainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextViewResult = findViewById(R.id.gbpRateValue);
        dateStatusValue = findViewById(R.id.dateStatusValue);
        requestQueue = Volley.newRequestQueue(this);

        JsonParseSingleCurrency.jsonParsing("https://api.nbp.pl/api/exchangerates/rates/A/GBP/?format=json","mid",this,requestQueue,mTextViewResult);
    ...
    private void barChartCurrRates() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                BarChart barChart = findViewById(R.id.gbpLineChart);
